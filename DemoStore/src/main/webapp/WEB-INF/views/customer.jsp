				...
				<table class="table">
				  	...
				  	<c:forEach items="${customerList}" var="c">
					  	<tr>
					  		...
					  		<td>${c.level}</td>
					  		<td>
					  			<a class="btn btn-default" href="updateCustomer?id=${c.id}">修改</a>
					  			<a class="btn btn-sm btn-danger deleteBtn" href="#" data-toggle="modal" data-target="#deleteModal" data-id="${c.id}">刪除</a>
					  		</td>
					  	</tr>
				  	</c:forEach>
				</table>
