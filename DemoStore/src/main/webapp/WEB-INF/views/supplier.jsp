		...
		<div class="container" >
			<div class="row">
				<br>
					...
					<a class="btn btn-primary" href="insertSupplier">新增</a>
					<table class="table">
						<tr>
							<th>供應商編號</th>
							<th>供應商名稱</th>
						...
						<c:forEach items="${supplierList}" var="supplier">
							<tr>
								...
								<td><a class="btn btn-default"
									href="updateSupplier?id=${supplier.supplierid}">修改</a> <a
									class="btn btn-sm btn-danger deleteBtn" href="#"
									data-toggle="modal" data-target="#deleteModal"
									data-id="${supplier.supplierid}">刪除</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
			...
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<form id="deleteForm" action="deleteSupplier" method="post">
