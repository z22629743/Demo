	...
	public int sellProduct(List<Product> pList) throws SQLException {
		...
		try {
			...
			*/
			...
			String sqlCreateOrder = "INSERT INTO salesOrder (ShippingTime) VALUES(Now())";
		    ...
		    for (Product aProduct:pList){
		    	...
		    	String sqlInsertOrderItem = "INSERT INTO salesorderitem (SOID, ProductID, Quantity, customerID,ShippingTime) VALUES(?, ?, ?, ?,Now())";
